...
pub use crate::lib::zstd::{
    ZSTD_cParameter, ZSTD_inBuffer, ZSTD_outBuffer, ZSTD_strategy, ZSTD_BLOCKSIZELOG_MAX,
    ZSTD_BLOCKSIZE_MAX, ZSTD_CLEVEL_DEFAULT, ZSTD_MAGICNUMBER, ZSTD_MAGIC_DICTIONARY,
    ZSTD_MAGIC_SKIPPABLE_MASK, ZSTD_MAGIC_SKIPPABLE_START, ZSTD_VERSION_MAJOR, ZSTD_VERSION_MINOR,
    ZSTD_VERSION_NUMBER, ZSTD_VERSION_RELEASE,
};
