...
pub const ZSTD_UNZSTD: [std::ffi::c_char; 7] =
    unsafe { *::core::mem::transmute::<&[u8; 7], &[std::ffi::c_char; 7]>(b"unzstd\0") };
pub const ZSTD_CAT: [std::ffi::c_char; 8] =
    unsafe { *::core::mem::transmute::<&[u8; 8], &[std::ffi::c_char; 8]>(b"zstdcat\0") };
pub const ZSTD_ZCAT: [std::ffi::c_char; 5] =
    unsafe { *::core::mem::transmute::<&[u8; 5], &[std::ffi::c_char; 5]>(b"zcat\0") };
pub const ZSTD_GZ: [std::ffi::c_char; 5] =
    unsafe { *::core::mem::transmute::<&[u8; 5], &[std::ffi::c_char; 5]>(b"gzip\0") };
pub const ZSTD_GUNZIP: [std::ffi::c_char; 7] =
    unsafe { *::core::mem::transmute::<&[u8; 7], &[std::ffi::c_char; 7]>(b"gunzip\0") };
pub const ZSTD_GZCAT: [std::ffi::c_char; 6] =
    unsafe { *::core::mem::transmute::<&[u8; 6], &[std::ffi::c_char; 6]>(b"gzcat\0") };
pub const ZSTD_LZMA: [std::ffi::c_char; 5] =
    unsafe { *::core::mem::transmute::<&[u8; 5], &[std::ffi::c_char; 5]>(b"lzma\0") };
pub const ZSTD_UNLZMA: [std::ffi::c_char; 7] =
    unsafe { *::core::mem::transmute::<&[u8; 7], &[std::ffi::c_char; 7]>(b"unlzma\0") };
pub const ZSTD_XZ: [std::ffi::c_char; 3] =
    unsafe { *::core::mem::transmute::<&[u8; 3], &[std::ffi::c_char; 3]>(b"xz\0") };
pub const ZSTD_UNXZ: [std::ffi::c_char; 5] =
    unsafe { *::core::mem::transmute::<&[u8; 5], &[std::ffi::c_char; 5]>(b"unxz\0") };
pub const ZSTD_LZ4: [std::ffi::c_char; 4] =
...
unsafe extern "C" fn parseCoverParameters(
    ...
    if g_displayLevel >= 4 as std::ffi::c_int {
        fprintf(
            ...
            (*params).d,
            (*params).steps,
            ((*params).splitPoint * 100 as std::ffi::c_int as std::ffi::c_double)
                as std::ffi::c_uint,
...
unsafe extern "C" fn parseLegacyParameters(
    mut stringPtr: *const std::ffi::c_char,
    mut selectivity: *mut std::ffi::c_uint,
) -> std::ffi::c_uint {
    if longCommandWArg(
        &mut stringPtr,
...
unsafe extern "C" fn printDefaultCParams(
    ...
    fprintf(
        ...
        *ZSTD_strategyMap
            .as_mut_ptr()
            .offset(cParams.strategy as std::ffi::c_int as isize),
...
pub const ENV_CLEVEL: [std::ffi::c_char; 12] =
    unsafe { *::core::mem::transmute::<&[u8; 12], &[std::ffi::c_char; 12]>(b"ZSTD_CLEVEL\0") };
pub const ENV_NBWORKERS: [std::ffi::c_char; 15] =
    unsafe { *::core::mem::transmute::<&[u8; 15], &[std::ffi::c_char; 15]>(b"ZSTD_NBTHREADS\0") };
                ...
                == '-' as i32
            {
                if *argument.offset(1 as std::ffi::c_int as isize) as std::ffi::c_int == '-' as i32
                {
                    ...
                    ) == 0
                    {
                        ...
                        argument,
                        b"--format=gzip\0" as *const u8 as *const std::ffi::c_char,
                    ) == 0
                    {
                        suffix = GZ_EXTENSION.as_ptr();
                        cType = FIO_gzipCompression;
                        ...
                        match current_block {
                            ...
                            _ => {
                                if strcmp(
                                    argument,
                                    b"--format=lzma\0" as *const u8 as *const std::ffi::c_char,
                                ) == 0
                                {
                                    suffix = LZMA_EXTENSION.as_ptr();
                                    cType = FIO_lzmaCompression;
                                    ...
                                    argument,
                                    b"--format=xz\0" as *const u8 as *const std::ffi::c_char,
                                ) == 0
                                {
                                    suffix = XZ_EXTENSION.as_ptr();
                                    cType = FIO_xzCompression;
                                ...
                                ) == 0
                                {
                                    ...
                                    &mut argument,
                                    b"--train-cover\0" as *const u8 as *const std::ffi::c_char,
                                ) != 0
                                {
                                    operation = zom_train;
                                    if outFileName.is_null() {
                                    ...
                                    &mut argument,
                                    b"--train-fastcover\0" as *const u8 as *const std::ffi::c_char,
                                ) != 0
                                {
                                    operation = zom_train;
                                    if outFileName.is_null() {
                                    ...
                                    &mut argument,
                                    b"--train-legacy\0" as *const u8 as *const std::ffi::c_char,
                                ) != 0
                                {
                                    operation = zom_train;
                                    if outFileName.is_null() {
