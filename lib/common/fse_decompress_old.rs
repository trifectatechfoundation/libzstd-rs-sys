...
struct BIT_DStream_t {
    ...
    limitPtr: *const core::ffi::c_char,
}

type BIT_DStream_status = core::ffi::c_uint;
...
type FSE_DTable = core::ffi::c_uint;
...
unsafe extern "C" fn BIT_initDStream(
    ...
    if srcSize < 1 as core::ffi::c_int as size_t {
        core::ptr::write_bytes(
            bitD as *mut u8,
            0,
            ::core::mem::size_of::<BIT_DStream_t>() as core::ffi::c_ulong as libc::size_t,
        );
    ...
    if srcSize >= ::core::mem::size_of::<BitContainerType>() as core::ffi::c_ulong {
        ...
        let lastByte = *(srcBuffer as *const u8)
            .offset(srcSize.wrapping_sub(1 as core::ffi::c_int as size_t) as isize);
        ...
        match srcSize {
            7 => {
                (*bitD).bitContainer = ((*bitD).bitContainer).wrapping_add(
                    (*(srcBuffer as *const u8).offset(6 as core::ffi::c_int as isize)
                        as BitContainerType)
                        << (::core::mem::size_of::<BitContainerType>() as core::ffi::c_ulong)
                            .wrapping_mul(8 as core::ffi::c_int as core::ffi::c_ulong)
                            .wrapping_sub(16 as core::ffi::c_int as core::ffi::c_ulong),
                );
        ...
        if current_block_32 == 1526876707632491634 {
            (*bitD).bitContainer = ((*bitD).bitContainer).wrapping_add(
                (*(srcBuffer as *const u8).offset(5 as core::ffi::c_int as isize)
                    as BitContainerType)
                    << (::core::mem::size_of::<BitContainerType>() as core::ffi::c_ulong)
                        .wrapping_mul(8 as core::ffi::c_int as core::ffi::c_ulong)
                        .wrapping_sub(24 as core::ffi::c_int as core::ffi::c_ulong),
            );
            current_block_32 = 3132044029094175486;
        }
        if current_block_32 == 3132044029094175486 {
            (*bitD).bitContainer = ((*bitD).bitContainer).wrapping_add(
                (*(srcBuffer as *const u8).offset(4 as core::ffi::c_int as isize)
                    as BitContainerType)
                    << (::core::mem::size_of::<BitContainerType>() as core::ffi::c_ulong)
                        .wrapping_mul(8 as core::ffi::c_int as core::ffi::c_ulong)
                        .wrapping_sub(32 as core::ffi::c_int as core::ffi::c_ulong),
            );
            current_block_32 = 5336772990438301456;
        }
        if current_block_32 == 5336772990438301456 {
            (*bitD).bitContainer = ((*bitD).bitContainer).wrapping_add(
                (*(srcBuffer as *const u8).offset(3 as core::ffi::c_int as isize)
                    as BitContainerType)
        ...
        if current_block_32 == 11143942153966811798 {
            (*bitD).bitContainer = ((*bitD).bitContainer).wrapping_add(
                (*(srcBuffer as *const u8).offset(2 as core::ffi::c_int as isize)
                    as BitContainerType)
        ...
        if current_block_32 == 2397150252174490634 {
            (*bitD).bitContainer = ((*bitD).bitContainer).wrapping_add(
                (*(srcBuffer as *const u8).offset(1 as core::ffi::c_int as isize)
                    as BitContainerType)
                    << 8 as core::ffi::c_int,
            );
        }
        ...
        (*bitD).bitsConsumed = ((*bitD).bitsConsumed).wrapping_add(
            (::core::mem::size_of::<BitContainerType>() as core::ffi::c_ulong).wrapping_sub(srcSize)
                as u32
...
unsafe extern "C" fn BIT_getMiddleBits(
    ...
    let regMask = (::core::mem::size_of::<BitContainerType>() as core::ffi::c_ulong)
        .wrapping_mul(8 as core::ffi::c_int as core::ffi::c_ulong)
        .wrapping_sub(1 as core::ffi::c_int as core::ffi::c_ulong) as u32;
    bitContainer >> (start & regMask)
        & ((1 as core::ffi::c_int as u64) << nbBits).wrapping_sub(1 as core::ffi::c_int as u64)
}
#[inline(always)]
unsafe extern "C" fn BIT_lookBits(
    ...
    BIT_getMiddleBits(
        ...
        (::core::mem::size_of::<BitContainerType>() as core::ffi::c_ulong)
            .wrapping_mul(8 as core::ffi::c_int as core::ffi::c_ulong)
            .wrapping_sub((*bitD).bitsConsumed as core::ffi::c_ulong)
...
unsafe extern "C" fn BIT_reloadDStream_internal(
    ...
    (*bitD).ptr = ((*bitD).ptr).offset(-(((*bitD).bitsConsumed >> 3 as core::ffi::c_int) as isize));
    (*bitD).bitsConsumed &= 7 as core::ffi::c_int as core::ffi::c_uint;
    (*bitD).bitContainer = MEM_readLEST((*bitD).ptr as *const core::ffi::c_void);
    BIT_DStream_unfinished
}
#[inline(always)]
unsafe extern "C" fn BIT_reloadDStream(mut bitD: *mut BIT_DStream_t) -> BIT_DStream_status {
    if ((*bitD).bitsConsumed as core::ffi::c_ulong
        > (::core::mem::size_of::<BitContainerType>() as core::ffi::c_ulong)
            .wrapping_mul(8 as core::ffi::c_int as core::ffi::c_ulong)) as core::ffi::c_int
        as core::ffi::c_long
        != 0
    {
        static zeroFilled: BitContainerType = 0 as core::ffi::c_int as BitContainerType;
        (*bitD).ptr = &zeroFilled as *const BitContainerType as *const core::ffi::c_char;
    ...
    let mut nbBytes = (*bitD).bitsConsumed >> 3 as core::ffi::c_int;
    ...
    (*bitD).bitsConsumed =
        ((*bitD).bitsConsumed).wrapping_sub(nbBytes * 8 as core::ffi::c_int as u32);
    (*bitD).bitContainer = MEM_readLEST((*bitD).ptr as *const core::ffi::c_void);
    result
}
#[inline]
unsafe extern "C" fn FSE_initDState(
    ...
    (*DStatePtr).state = BIT_readBits(bitD, (*DTableH).tableLog as core::ffi::c_uint);
...
unsafe extern "C" fn FSE_buildDTable_internal(
    ...
    let tdPtr = dt.offset(1 as core::ffi::c_int as isize) as *mut core::ffi::c_void;
    ...
    let mut spread = symbolNext
        ...
        .offset(1 as core::ffi::c_int as isize) as *mut u8;
    let maxSV1 = maxSymbolValue.wrapping_add(1 as core::ffi::c_int as core::ffi::c_uint);
    let tableSize = ((1 as core::ffi::c_int) << tableLog) as u32;
    let mut highThreshold = tableSize.wrapping_sub(1 as core::ffi::c_int as u32);
    if ((::core::mem::size_of::<core::ffi::c_short>() as core::ffi::c_ulong).wrapping_mul(
        maxSymbolValue.wrapping_add(1 as core::ffi::c_int as core::ffi::c_uint)
            as core::ffi::c_ulong,
    ) as core::ffi::c_ulonglong)
        .wrapping_add((1 as core::ffi::c_ulonglong) << tableLog)
        .wrapping_add(8 as core::ffi::c_int as core::ffi::c_ulonglong)
    ...
    DTableH.fastMode = 1 as core::ffi::c_int as u16;
    let largeLimit = ((1 as core::ffi::c_int)
        << tableLog.wrapping_sub(1 as core::ffi::c_int as core::ffi::c_uint))
        as i16;
    let mut s: u32 = 0;
    s = 0 as core::ffi::c_int as u32;
    while s < maxSV1 {
        if *normalizedCounter.offset(s as isize) as core::ffi::c_int == -(1 as core::ffi::c_int) {
            ...
            *symbolNext.offset(s as isize) = 1 as core::ffi::c_int as u16;
        } else {
            if *normalizedCounter.offset(s as isize) as core::ffi::c_int
                >= largeLimit as core::ffi::c_int
            {
                DTableH.fastMode = 0 as core::ffi::c_int as u16;
            }
    ...
    libc::memcpy(
        ...
        &mut DTableH as *mut FSE_DTableHeader as *const core::ffi::c_void,
        ::core::mem::size_of::<FSE_DTableHeader>() as core::ffi::c_ulong as libc::size_t,
    );
    if highThreshold == tableSize.wrapping_sub(1 as core::ffi::c_int as u32) {
        let tableMask = tableSize.wrapping_sub(1 as core::ffi::c_int as u32) as size_t;
        let step = (tableSize >> 1 as core::ffi::c_int)
            .wrapping_add(tableSize >> 3 as core::ffi::c_int)
            .wrapping_add(3 as core::ffi::c_int as u32) as size_t;
        ...
        let mut s_0: u32 = 0;
        s_0 = 0 as core::ffi::c_int as u32;
        while s_0 < maxSV1 {
        ...
        let unroll = 2 as core::ffi::c_int as size_t;
        s_1 = 0 as core::ffi::c_int as size_t;
        while s_1 < tableSize as size_t {
            let mut u: size_t = 0;
            u = 0 as core::ffi::c_int as size_t;
            while u < unroll {
        ...
        let tableMask_0 = tableSize.wrapping_sub(1 as core::ffi::c_int as u32);
        let step_0 = (tableSize >> 1 as core::ffi::c_int)
            .wrapping_add(tableSize >> 3 as core::ffi::c_int)
            .wrapping_add(3 as core::ffi::c_int as u32);
        let mut s_2: u32 = 0;
        let mut position_0 = 0 as core::ffi::c_int as u32;
        s_2 = 0 as core::ffi::c_int as u32;
        while s_2 < maxSV1 {
        ...
        if position_0 != 0 as core::ffi::c_int as u32 {
            return -(ZSTD_error_GENERIC as core::ffi::c_int) as size_t;
        }
    }
    let mut u_0: u32 = 0;
    u_0 = 0 as core::ffi::c_int as u32;
    while u_0 < tableSize {
...
unsafe extern "C" fn FSE_decompress_usingDTable_generic(
    ...
    let olimit = omax.offset(-(3 as core::ffi::c_int as isize));
    ...
    if BIT_reloadDStream(&mut bitD) as core::ffi::c_uint
        == BIT_DStream_overflow as core::ffi::c_int as core::ffi::c_uint
    {
        return -(ZSTD_error_corruption_detected as core::ffi::c_int) as size_t;
    }
    while (BIT_reloadDStream(&mut bitD) as core::ffi::c_uint
        ...
        != 0
    {
        *op.offset(0 as core::ffi::c_int as isize) = (if fast != 0 {
            FSE_decodeSymbolFast(&mut state1, &mut bitD) as core::ffi::c_int
        } else {
            FSE_decodeSymbol(&mut state1, &mut bitD) as core::ffi::c_int
        }) as u8;
        if (FSE_MAX_TABLELOG * 2 as core::ffi::c_int + 7 as core::ffi::c_int) as core::ffi::c_ulong
            > (::core::mem::size_of::<BitContainerType>() as core::ffi::c_ulong)
                .wrapping_mul(8 as core::ffi::c_int as core::ffi::c_ulong)
        {
        ...
        *op.offset(1 as core::ffi::c_int as isize) = (if fast != 0 {
            FSE_decodeSymbolFast(&mut state2, &mut bitD) as core::ffi::c_int
        } else {
            FSE_decodeSymbol(&mut state2, &mut bitD) as core::ffi::c_int
        }) as u8;
        if (FSE_MAX_TABLELOG * 4 as core::ffi::c_int + 7 as core::ffi::c_int) as core::ffi::c_ulong
            > (::core::mem::size_of::<BitContainerType>() as core::ffi::c_ulong)
                .wrapping_mul(8 as core::ffi::c_int as core::ffi::c_ulong)
            && BIT_reloadDStream(&mut bitD) as core::ffi::c_uint
                > BIT_DStream_unfinished as core::ffi::c_int as core::ffi::c_uint
        {
...
unsafe extern "C" fn FSE_decompress_wksp_body(
    ...
    let dtablePos = (::core::mem::size_of::<FSE_DecompressWksp>() as core::ffi::c_ulong)
        .wrapping_div(::core::mem::size_of::<FSE_DTable>() as core::ffi::c_ulong);
    ...
    if ((1 as core::ffi::c_int + ((1 as core::ffi::c_int) << tableLog) + 1 as core::ffi::c_int)
        as core::ffi::c_ulonglong)
        .wrapping_add(
            ((::core::mem::size_of::<core::ffi::c_short>() as core::ffi::c_ulong).wrapping_mul(
                maxSymbolValue.wrapping_add(1 as core::ffi::c_int as core::ffi::c_uint)
                    as core::ffi::c_ulong,
            ) as core::ffi::c_ulonglong)
                .wrapping_add((1 as core::ffi::c_ulonglong) << tableLog)
        ...
        .wrapping_add(1 as core::ffi::c_int as core::ffi::c_ulonglong)
        .wrapping_mul(
            ::core::mem::size_of::<core::ffi::c_uint>() as core::ffi::c_ulong
                as core::ffi::c_ulonglong,
        )
    ...
    workSpace = (workSpace as *mut u8)
        .offset(::core::mem::size_of::<FSE_DecompressWksp>() as core::ffi::c_ulong as isize)
        .offset(
            ((1 as core::ffi::c_int + ((1 as core::ffi::c_int) << tableLog)) as core::ffi::c_ulong)
    ...
    let mut ptr = dtable as *const core::ffi::c_void;
