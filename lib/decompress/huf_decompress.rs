...
unsafe extern "C" fn HUF_initFastDStream(mut ip: *const u8) -> size_t {
    ...
    let value = MEM_readLEST(ip as *const std::ffi::c_void) | 1;
    value << bitsConsumed
}
...
unsafe extern "C" fn HUF_DEltX1_set4(mut symbol: u8, mut nbBits: u8) -> u64 {
    ...
    if MEM_isLittleEndian() != 0 {
        D4 = (((symbol as std::ffi::c_int) << 8) + nbBits as std::ffi::c_int) as u64;
    } else {
        D4 = (symbol as std::ffi::c_int + ((nbBits as std::ffi::c_int) << 8)) as u64;
    }
    ...
    if tableLog < targetTableLog {
        ...
        while s < nbSymbols {
            ...
            *fresh12 = (*fresh12 as std::ffi::c_int
                + (if *huffWeight.offset(s as isize) as std::ffi::c_int == 0 {
                    0
                } else {
                    scale
...
pub unsafe fn HUF_readDTableX1_wksp(
    ...
    let maxTableLog = (dtd.maxTableLog as std::ffi::c_int + 1) as u32;
    ...
    if tableLog > (dtd.maxTableLog as std::ffi::c_int + 1) as u32 {
        return -(ZSTD_error_tableLog_tooLarge as std::ffi::c_int) as size_t;
    }
    dtd.tableType = 0;
    ...
    n = 0;
    while n < tableLog as std::ffi::c_int + 1 {
        ...
        match length {
            ...
            8 => {
                ...
                while s < symbolCount {
                    ...
                    MEM_write64(
                        dt.offset(uStart as isize).offset(4) as *mut std::ffi::c_void,
                        D4_0,
                    );
                    uStart += 8;
                    s += 1;
...
unsafe extern "C" fn HUF_decodeStreamX1(
    ...
    if pEnd.offset_from(p) as std::ffi::c_long > 3 {
        while (bitDPtr.reload() == StreamStatus::Unfinished) as std::ffi::c_int
            & (p < pEnd.offset(-(3))) as std::ffi::c_int
            != 0
        {
            if MEM_64bits() != 0 {
                let fresh17 = p;
...
unsafe extern "C" fn HUF_decompress1X1_usingDTable_internal_body(
    ...
    let mut dtPtr = DTable.offset(1) as *const std::ffi::c_void;
    ...
    's_33: loop {
        ...
        loop {
            ...
            *bits.as_mut_ptr().offset(0) =
                MEM_read64(*ip.as_mut_ptr().offset(0) as *const std::ffi::c_void) | 1;
            ...
            *bits.as_mut_ptr().offset(1) =
                MEM_read64(*ip.as_mut_ptr().offset(1) as *const std::ffi::c_void) | 1;
            ...
            *bits.as_mut_ptr().offset(2) =
                MEM_read64(*ip.as_mut_ptr().offset(2) as *const std::ffi::c_void) | 1;
            ...
            *bits.as_mut_ptr().offset(3) =
                MEM_read64(*ip.as_mut_ptr().offset(3) as *const std::ffi::c_void) | 1;
...
unsafe extern "C" fn HUF_fillDTableX2ForWeight(
    ...
    let length = (1) << (tableLog.wrapping_sub(nbBits) & 0x1f as std::ffi::c_int as u32);
    ...
    match length {
        ...
        8 => {
            ...
            while ptr != end {
                ...
                libc::memcpy(
                    DTableRank.offset(4) as *mut std::ffi::c_void,
                    &DEltX2_0 as *const u64 as *const std::ffi::c_void,
                    ::core::mem::size_of::<u64>() as std::ffi::c_ulong as libc::size_t,
                );
                libc::memcpy(
                    DTableRank.offset(6) as *mut std::ffi::c_void,
                    &DEltX2_0 as *const u64 as *const std::ffi::c_void,
                    ::core::mem::size_of::<u64>() as std::ffi::c_ulong as libc::size_t,
                );
...
unsafe extern "C" fn HUF_fillDTableX2Level2(
    ...
    if minWeight > 1 {
        let length = (1) << (targetLog.wrapping_sub(consumedBits) & 0x1f as std::ffi::c_int as u32);
        ...
        match length {
            ...
            4 => {
                libc::memcpy(
                    DTable.offset(0) as *mut std::ffi::c_void,
                    &DEltX2 as *const u64 as *const std::ffi::c_void,
                    ::core::mem::size_of::<u64>() as std::ffi::c_ulong as libc::size_t,
                );
                libc::memcpy(
                    DTable.offset(2) as *mut std::ffi::c_void,
                    &DEltX2 as *const u64 as *const std::ffi::c_void,
                    ::core::mem::size_of::<u64>() as std::ffi::c_ulong as libc::size_t,
                );
            }
            _ => {
                ...
                while i < skipSize {
                    libc::memcpy(
                        DTable.offset(i as isize).offset(0) as *mut std::ffi::c_void,
                        &DEltX2 as *const u64 as *const std::ffi::c_void,
                        ::core::mem::size_of::<u64>() as std::ffi::c_ulong as libc::size_t,
                    );
                    libc::memcpy(
                        DTable.offset(i as isize).offset(2) as *mut std::ffi::c_void,
                        &DEltX2 as *const u64 as *const std::ffi::c_void,
                        ::core::mem::size_of::<u64>() as std::ffi::c_ulong as libc::size_t,
                    );
                    libc::memcpy(
                        DTable.offset(i as isize).offset(4) as *mut std::ffi::c_void,
                        &DEltX2 as *const u64 as *const std::ffi::c_void,
                        ::core::mem::size_of::<u64>() as std::ffi::c_ulong as libc::size_t,
                    );
                    libc::memcpy(
                        DTable.offset(i as isize).offset(6) as *mut std::ffi::c_void,
                        &DEltX2 as *const u64 as *const std::ffi::c_void,
                        ::core::mem::size_of::<u64>() as std::ffi::c_ulong as libc::size_t,
                    );
                    i += 8;
    ...
    while w < maxWeight1 {
        ...
        let end = *rankStart.offset((w + 1) as isize) as std::ffi::c_int;
...
unsafe extern "C" fn HUF_fillDTableX2(
    ...
    while w < wEnd {
        ...
        if targetLog.wrapping_sub(nbBits) >= minBits {
            ...
            let length = (1) << (targetLog.wrapping_sub(nbBits) & 0x1f as std::ffi::c_int as u32);
...
pub unsafe extern "C" fn HUF_readDTableX2_wksp(
    ...
    let mut iSize: size_t = 0;
    let mut dtPtr = DTable.offset(1) as *mut std::ffi::c_void;
    ...
    *rankStart.offset(0) = 0;
    ...
    let rescale = maxTableLog.wrapping_sub(tableLog).wrapping_sub(1) as std::ffi::c_int;
...
unsafe extern "C" fn HUF_decodeStreamX2(
        ...
        >= ::core::mem::size_of::<BitContainerType>() as std::ffi::c_ulong
    {
        if dtLog <= 11 && MEM_64bits() != 0 {
            while (bitDPtr.reload() == StreamStatus::Unfinished) as std::ffi::c_int
                & (p < pEnd.offset(-(9))) as std::ffi::c_int
                != 0
            {
                p = p.offset(
    ...
    if pEnd.offset_from(p) as std::ffi::c_long as size_t >= 2 {
        while (bitDPtr.reload() == StreamStatus::Unfinished) as std::ffi::c_int
            & (p <= pEnd.offset(-(2))) as std::ffi::c_int
            != 0
        {
            p = p.offset(
                HUF_decodeSymbolX2(p as *mut std::ffi::c_void, bitDPtr, dt, dtLog) as isize,
    ...
    's_45: loop {
        ...
        loop {
            if 0 != 0 || 0 != 3 {
                ...
                MEM_write16(
                    *op.as_mut_ptr().offset(0) as *mut std::ffi::c_void,
                    entry.sequence,
                );
                *bits.as_mut_ptr().offset(0) <<=
            ...
            if 0 != 0 || 1 != 3 {
                ...
                MEM_write16(
                    *op.as_mut_ptr().offset(1) as *mut std::ffi::c_void,
                    entry_0.sequence,
                );
                *bits.as_mut_ptr().offset(1) <<=
            ...
            if 0 != 0 || 2 != 3 {
                ...
                MEM_write16(
                    *op.as_mut_ptr().offset(2) as *mut std::ffi::c_void,
                    entry_1.sequence,
                );
                *bits.as_mut_ptr().offset(2) <<=
            ...
            if 0 != 0 || 3 != 3 {
                ...
                MEM_write16(
                    *op.as_mut_ptr().offset(3) as *mut std::ffi::c_void,
                    entry_2.sequence,
                );
                *bits.as_mut_ptr().offset(3) <<=
            ...
            if 1 != 0 || 3 != 3 {
                let index_19 = (*bits.as_mut_ptr().offset(3) >> 53) as std::ffi::c_int;
            ...
            if 1 != 0 || 3 != 3 {
                let index_20 = (*bits.as_mut_ptr().offset(3) >> 53) as std::ffi::c_int;
            ...
            *bits.as_mut_ptr().offset(0) <<= nbBits;
            if 1 != 0 || 3 != 3 {
                let index_21 = (*bits.as_mut_ptr().offset(3) >> 53) as std::ffi::c_int;
            ...
            *bits.as_mut_ptr().offset(1) <<= nbBits_0;
            if 1 != 0 || 3 != 3 {
                let index_22 = (*bits.as_mut_ptr().offset(3) >> 53) as std::ffi::c_int;
            ...
            *bits.as_mut_ptr().offset(2) <<= nbBits_1;
            if 1 != 0 || 3 != 3 {
                let index_23 = (*bits.as_mut_ptr().offset(3) >> 53) as std::ffi::c_int;
