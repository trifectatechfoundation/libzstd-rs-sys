...
pub unsafe fn FSE_isError(mut code: size_t) -> core::ffi::c_uint {
    ERR_isError(code)
}
...
unsafe extern "C" fn FSE_readNCount_body(
    ...
    let maxSV1 = (*maxSVPtr).wrapping_add(1 as core::ffi::c_int as core::ffi::c_uint);
    let mut previous0 = 0 as core::ffi::c_int;
    if hbSize < 8 as core::ffi::c_int as size_t {
        let mut buffer: [core::ffi::c_char; 8] = [0 as core::ffi::c_int as core::ffi::c_char; 8];
        libc::memcpy(
        ...
        let countSize = FSE_readNCount(
            ...
            ::core::mem::size_of::<[core::ffi::c_char; 8]>() as core::ffi::c_ulong,
        );
    ...
    core::ptr::write_bytes(
        ...
        0,
        ((*maxSVPtr).wrapping_add(1 as core::ffi::c_int as core::ffi::c_uint) as core::ffi::c_ulong)
            .wrapping_mul(::core::mem::size_of::<core::ffi::c_short>() as core::ffi::c_ulong)
            as libc::size_t,
    );
    ...
    *tableLogPtr = nbBits as core::ffi::c_uint;
    ...
    loop {
        if previous0 != 0 {
            let mut repeats =
                (ZSTD_countTrailingZeros32(!bitStream | 0x80000000 as core::ffi::c_uint)
            ...
            while repeats >= 12 as core::ffi::c_int {
                    ...
                    != 0
                {
                    ...
                    bitCount -= (8 as core::ffi::c_int as core::ffi::c_long
                        * iend
                ...
                repeats = (ZSTD_countTrailingZeros32(!bitStream | 0x80000000 as core::ffi::c_uint)
                    >> 1 as core::ffi::c_int) as core::ffi::c_int;
            }
            charnum = charnum.wrapping_add((3 as core::ffi::c_int * repeats) as core::ffi::c_uint);
            bitStream >>= 2 as core::ffi::c_int * repeats;
            bitCount += 2 as core::ffi::c_int * repeats;
            charnum = charnum.wrapping_add(bitStream & 3 as core::ffi::c_int as u32);
        ...
        let max = 2 as core::ffi::c_int * threshold - 1 as core::ffi::c_int - remaining;
        let mut count: core::ffi::c_int = 0;
        if (bitStream & (threshold - 1 as core::ffi::c_int) as u32) < max as u32 {
            count = (bitStream & (threshold - 1 as core::ffi::c_int) as u32) as core::ffi::c_int;
            bitCount += nbBits - 1 as core::ffi::c_int;
        } else {
            count = (bitStream & (2 as core::ffi::c_int * threshold - 1 as core::ffi::c_int) as u32)
                as core::ffi::c_int;
            if count >= threshold {
                count -= max;
            }
        ...
        *normalizedCounter.offset(fresh0 as isize) = count as core::ffi::c_short;
        ...
        if (ip <= iend.offset(-(7 as core::ffi::c_int as isize))) as core::ffi::c_int
            as core::ffi::c_long
            != 0
            || ip.wrapping_offset((bitCount >> 3 as core::ffi::c_int) as isize)
                <= iend.offset(-(4 as core::ffi::c_int as isize))
        {
            ip = ip.offset((bitCount >> 3 as core::ffi::c_int) as isize);
            bitCount &= 7 as core::ffi::c_int;
    ...
    *maxSVPtr = charnum.wrapping_sub(1 as core::ffi::c_int as core::ffi::c_uint);
...
pub(crate) unsafe fn HUF_readStats_body(
    ...
    if iSize >= 128 as core::ffi::c_int as size_t {
        oSize = iSize.wrapping_sub(127 as core::ffi::c_int as size_t);
        iSize =
            oSize.wrapping_add(1 as core::ffi::c_int as size_t) / 2 as core::ffi::c_int as size_t;
        if iSize.wrapping_add(1 as core::ffi::c_int as size_t) > srcSize {
            return -(ZSTD_error_srcSize_wrong as core::ffi::c_int) as size_t;
        }
        if oSize >= hwSize {
            return -(ZSTD_error_corruption_detected as core::ffi::c_int) as size_t;
        ...
        let mut n: u32 = 0;
        n = 0 as core::ffi::c_int as u32;
        while (n as size_t) < oSize {
            *huffWeight.offset(n as isize) =
                (*ip.offset((n / 2 as core::ffi::c_int as u32) as isize) as core::ffi::c_int
                    >> 4 as core::ffi::c_int) as u8;
            *huffWeight.offset(n.wrapping_add(1 as core::ffi::c_int as u32) as isize) =
                (*ip.offset((n / 2 as core::ffi::c_int as u32) as isize) as core::ffi::c_int
                    & 15 as core::ffi::c_int) as u8;
            n = n.wrapping_add(2 as core::ffi::c_int as u32);
        }
    } else {
        if iSize.wrapping_add(1 as core::ffi::c_int as size_t) > srcSize {
            return -(ZSTD_error_srcSize_wrong as core::ffi::c_int) as size_t;
        ...
        oSize = FSE_decompress_wksp_bmi2(
            ...
            hwSize.wrapping_sub(1 as core::ffi::c_int as size_t),
    ...
    core::ptr::write_bytes(
        rankStats as *mut u8,
        0,
        ((12 as core::ffi::c_int + 1 as core::ffi::c_int) as core::ffi::c_ulong)
            .wrapping_mul(::core::mem::size_of::<u32>() as core::ffi::c_ulong)
            as libc::size_t,
    );
    weightTotal = 0 as core::ffi::c_int as u32;
    let mut n_0: u32 = 0;
    n_0 = 0 as core::ffi::c_int as u32;
    ...
    if weightTotal == 0 as core::ffi::c_int as u32 {
        return -(ZSTD_error_corruption_detected as core::ffi::c_int) as size_t;
    }
    let tableLog =
        (ZSTD_highbit32(weightTotal)).wrapping_add(1 as core::ffi::c_int as core::ffi::c_uint);
    if tableLog > HUF_TABLELOG_MAX as u32 {
        return -(ZSTD_error_corruption_detected as core::ffi::c_int) as size_t;
    }
    *tableLogPtr = tableLog;
    let total = ((1 as core::ffi::c_int) << tableLog) as u32;
    let rest = total.wrapping_sub(weightTotal);
    let verif = ((1 as core::ffi::c_int) << ZSTD_highbit32(rest)) as u32;
    let lastWeight =
        (ZSTD_highbit32(rest)).wrapping_add(1 as core::ffi::c_int as core::ffi::c_uint);
    if verif != rest {
        return -(ZSTD_error_corruption_detected as core::ffi::c_int) as size_t;
    }
    ...
    *fresh2 = (*fresh2).wrapping_add(1);
    if *rankStats.offset(1 as core::ffi::c_int as isize) < 2 as core::ffi::c_int as u32
        || *rankStats.offset(1 as core::ffi::c_int as isize) & 1 as core::ffi::c_int as u32 != 0
    {
        return -(ZSTD_error_corruption_detected as core::ffi::c_int) as size_t;
    }
    *nbSymbolsPtr = oSize.wrapping_add(1 as core::ffi::c_int as size_t) as u32;
    iSize.wrapping_add(1 as core::ffi::c_int as size_t)
}
