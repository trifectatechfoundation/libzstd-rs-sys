...
pub use crate::lib::zstd::{
    ...
    ZSTD_CLEVEL_DEFAULT, ZSTD_FRAMEHEADERSIZE_MAX, ZSTD_MAGICNUMBER, ZSTD_MAGIC_DICTIONARY,
...
pub use crate::lib::compress::zstd_compress::{
    ...
    ZSTD_TARGETCBLOCKSIZE_MIN, ZSTD_TARGETLENGTH_MAX, ZSTD_TARGETLENGTH_MIN, ZSTD_WINDOWLOG_MIN,
};
